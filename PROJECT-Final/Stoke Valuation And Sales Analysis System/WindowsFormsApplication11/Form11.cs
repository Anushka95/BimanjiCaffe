...
{
    public partial class Form_SelectFoodsCashier : Form
    {
        double salesRolls;
        double salesBuns;
        ...
        SqlConnection con5 = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=G:\My Documents\ESOFT\Educational\Projects\Our Project\Software\PROJECT-Final\Stoke Valuation And Sales Analysis System\WindowsFormsApplication11\Database1.mdf;Integrated Security=True;User Instance=True");

        public Form_SelectFoodsCashier()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com2 = new SqlCommand("SELECT*FROM Table_Stock WHERE Date='" + theDate + "'", con5);
            try
            {
                con5.Open();
            }
            ...
            SqlCommand com3 = new SqlCommand("SELECT*FROM Table_Sales WHERE Date='" + thedate + "'", con5);
            try
            {
                con5.Open();
            }
            ...
            SqlCommand com1 = new SqlCommand("SELECT * FROM Table_Prices WHERE TheKey='" + key + "'", con5);
            ...
            String theDAte = dateTimePicker1.Value.ToString("yyyy-MM-dd");
            SqlCommand comm = new SqlCommand("UPDATE Table_Stock SET Rolls=@rolls , Buns=@buns , FishBuns=@fishbuns , EggBuns=@eggBuns , Pastry=@pastry , Vade=@vade , UlunduVade=@ulunduvade , CupCake=@cupcake , Patis=@patis , Rotti=@rotti WHERE Date=@date", con5);
            ...
            String theDATe = dateTimePicker1.Value.ToString("yyyy-MM-dd");
            SqlCommand commm = new SqlCommand("UPDATE Table_Sales SET Rolls=@rolls , Buns=@buns , FishBuns=@fishbuns , EggBuns=@eggBuns , Pastry=@pastry , Vade=@vade , UlunduVade=@ulunduvade , CupCake=@cupcake , Patis=@patis , Rotti=@rotti WHERE Date=@date", con5);
        ...
        private void Form_SelectFoodsCashier_Load(object sender, EventArgs e)
        {
            comboBox1.Text = "0";
            comboBox2.Text = "0";
            comboBox3.Text = "0";
